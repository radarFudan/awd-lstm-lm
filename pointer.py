...
parser.add_argument(
    "--model", type=str, default="LSTM", help="type of recurrent net (LSTM, QRNN)"
)
parser.add_argument(
    "--save", type=str, default="best.pt", help="model to use the pointer over"
)
parser.add_argument("--cuda", action="store_false", help="use CUDA")
parser.add_argument("--bptt", type=int, default=5000, help="sequence length")
    ...
    for i in range(0, data_source.size(0) - 1, args.bptt):
        ...
        for idx, vocab_loss in enumerate(softmax_output_flat):
            ...
            if start_idx + idx > window:
                ...
                ptr_dist = (
                    (ptr_attn.expand_as(valid_next_word) * valid_next_word)
                    .sum(0)
                    .squeeze()
                )
...
print("=" * 89)
print(
    "| End of pointer | val loss {:5.2f} | val ppl {:8.2f}".format(
...
print("=" * 89)
print(
    "| End of pointer | test loss {:5.2f} | test ppl {:8.2f}".format(
